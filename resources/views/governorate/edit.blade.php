        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('governorate.index') }}" class="breadcrumb-item">المحافظات</a>
                    <span class="breadcrumb-item active">تعديل المحافظة</span>
                    <span class="breadcrumb-item active">{{ $governorate->name  }}</span>
                </div>
            </div>
...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">تعديل المحافظة</h5>
        ...
        <div class="card-body">
            <form action="{{ route('governorate.update' , $governorate->id) }}" method="post">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="اسم المحافظة"
                                   value="{{ $governorate->name }}" required>
                            @error('name')
                ...
                <a href="{{ route('governorate.index') }}" class="btn btn-link">الغاء</a>
            </form>
        </div>
    </div>
@endsection
