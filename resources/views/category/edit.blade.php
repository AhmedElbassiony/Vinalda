        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('category.index') }}" class="breadcrumb-item">الفئات</a>
                    <span class="breadcrumb-item active">تعديل الفئة</span>
...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">تعديل الفئة</h5>
        ...
        <div class="card-body">
            <form action="{{ route('category.update' , $category->id) }}" method="post">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="اسم الفئة"
                ...
                <a href="{{ route('category.index') }}" class="btn btn-link">الغاء</a>
            </form>
        </div>
    </div>
@endsection
