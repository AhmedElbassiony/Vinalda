        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                <div class="breadcrumb justify-content-center">
                    <a href="{{ route('expense.create') }}" class="breadcrumb-elements-item font-weight-bold">
                        <i class="icon-plus2 mr-2"></i>
                        اضافة نوع مصروفات جديد
                    </a>
                </div>
            </div>
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">انواع المصروفات</h5>
        </div>
        ...
        <table class="table datatable-button-init-basic table-bordered text-center">
            ...
            <tr>
                ...
                <th class="text-center">اسم نوع المصروفات</th>
