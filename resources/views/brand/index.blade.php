        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">العلامات التجارية</span>
                </div>
            ...
            <div class="header-elements d-none">
                <div class="breadcrumb justify-content-center">
                    <a href="{{ route('brand.create') }}" class="breadcrumb-elements-item font-weight-bold">
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">العلامات التجارية</h5>
        </div>
        ...
        <table class="table datatable-button-init-basic table-bordered text-center">
            ...
            <tr>
                ...
                <th class="text-center">اسم العلامة التجارية</th>
