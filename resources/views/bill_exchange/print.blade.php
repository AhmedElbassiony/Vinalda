...
<div class="invoice-box">
                ...
                <table class="new-table my-3">
                    <tr>
                        ...
                        <td class="height_line" style="font-size: 18px">
                            رقم الفاتورة : <span>{{ $billExchange->code  }}</span><br/>
                            تاريخ الفاتورة : <span>{{ $billExchange->date->format('Y-m-d') ?? null  }}</span><br/>
                            اسم المخزن المحول منه : <span>{{ $billExchange->stock->name ?? null  }}</span> <br/>
                            اسم المخزن المحول اليه : <span>{{ $billExchange->toStock->name ?? null  }}</span> <br/>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <div class="table-responsive-sm">
        <table class="table table-striped text-center table-bordered">
            ...
            <tbody>
            @foreach($billExchange->items as $item)
                <tr>
