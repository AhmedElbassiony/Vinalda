        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">تعديل العميل</span>
...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">تعديل العميل</h5>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select-search select2-hidden-accessible" data-fouc=""
                                ...
                                @foreach($governorates as $governorate)
                                    <option value="{{ $governorate->id }}" {{ $client->governorate_id == $governorate->id ? 'selected' : '' }}>{{ $governorate->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
