        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">العملاء</span>
                </div>
            ...
            <div class="header-elements d-none">
                <div class="breadcrumb justify-content-center">
                    <a href="{{ route('clients.create') }}" class="breadcrumb-elements-item font-weight-bold">
...
@section('script')
    ...
    <script src="{{ asset('backend/global_assets/js/demo_pages/form_select2.js') }}"></script>    <script>
