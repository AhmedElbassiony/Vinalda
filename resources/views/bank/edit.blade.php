        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">تعديل البنك</span>
...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">تعديل البنك</h5>
        ...
        <div class="card-body">
            <form action="{{ route('bank.update' , $bank->id) }}" method="post">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="اسم البك"
                ...
                <a href="{{ route('bank.index') }}" class="btn btn-link">الغاء</a>
            </form>
        </div>
    </div>
@endsection
