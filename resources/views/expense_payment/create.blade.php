        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">اضافة مصروفات جديدة</span>
                </div>
            </div>
...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">اضافة مصروفات جديدة</h5>
        ...
        <div class="card-body">
            <form action="{{ route('expense-payment.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
