        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">المصروفات العامة</span>
                </div>
            ...
            <div class="header-elements d-none">
                <div class="breadcrumb justify-content-center">
                    <a href="{{ route('expense-payment.create') }}" class="breadcrumb-elements-item font-weight-bold">
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">مصروفات عامة</h5>
        </div>
        ...
        <table class="table datatable-button-init-basic table-bordered text-center">
            ...
            <tr>
                ...
                <th class="text-center">نوع المصروفات</th>
                <th class="text-center">تاريخ المصروفات</th>
...
@section('script')
    ...
    <script>
        var table = $('.datatable-button-init-basic').DataTable({
            // processing : true,
            // serverSide: true,
            ajax: '{{ route('expense-payment.data') }}',
            columns: [
                {
                    data: "id",
