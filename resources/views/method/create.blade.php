        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('method.index') }}" class="breadcrumb-item">طرق الدفع</a>
                    <span class="breadcrumb-item active">اضافة طريقة دفع جديدة</span>
                </div>
            </div>
...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">ضافة طريقة دفع جديدة</h5>
        ...
        <div class="card-body">
            <form action="{{ route('method.store') }}" method="post">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="اسم طريقة الدفع"
                ...
                <a href="{{ route('method.index') }}" class="btn btn-link">الغاء</a>
            </form>
        </div>
    </div>
@endsection
