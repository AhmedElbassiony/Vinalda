...
<div class="invoice-box">
                ...
                <table class="new-table my-3">
                    <tr>
                        ...
                        <td class="height_line" style="font-size: 18px">
                            رقم الفاتورة : <span>{{ $billSale->code  }}</span><br/>
                            تاريخ الفاتورة : <span>{{ $billSale->date->format('Y-m-d') ?? null  }}</span><br/>
                            اسم العميل : <span>{{ $billSale->client->name ?? null  }}</span> <br/>
                            رقم التليفون : <span>{{ $billSale->client->mobile ?? null  }}</span> <br/>
                            المحافظة : <span>{{ $billSale->client->governorate->name ?? null  }}</span> <br/>
                            العنوان : <span>{{ $billSale->client->address  }}</span> <br/>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <div class="table-responsive-sm">
        <table class="table table-striped text-center table-bordered">
            ...
            <tbody>
            @foreach($billSale->items as $item)
                <tr>
            ...
            <tr class="background-tr">
                ...
                <td class="text-center">{{ round($main_total , 2) }}</td>
            </tr>
            </tbody>
        </table>
    ...
    <table style="width:100% !important;" class="table mt-2">
        <tr>
            ...
            <td style="font-size: 15px; border: 0 !important;"
                class="font-weight-bold text-center">{{ round($main_total , 2)  }}</td>
            <td style="font-size: 15px; border: 0 !important;" class="font-weight-bold text-center">جنية</td>
            <td style="font-size: 15px; border: 0 !important;" class="font-weight-bold text-center">الخصم :</td>
            <td style="font-size: 15px; border: 0 !important;"
                class="font-weight-bold text-center">{{ round($discount , 2) }}</td>
            <td style="font-size: 15px; border: 0 !important;" class="font-weight-bold text-center">جنية</td>
            <td style="font-size: 15px; border: 0 !important;" class="font-weight-bold text-center">الضريبة :</td>
            <td style="font-size: 15px; border: 0 !important;"
                class="font-weight-bold text-center">{{ round($tax , 2) }}</td>
            <td style="font-size: 15px; border: 0 !important;" class="font-weight-bold text-center">جنية</td>
        </tr>
        <tr>
            <td style="font-size: 15px; border: 0 !important;" class="font-weight-bold text-center">صافى الفاتورة :</td>
            <td style="font-size: 15px; border: 0 !important;"
        ...
        <tr class="mt-2">
            ...
            <td colspan="8" style="font-size: 15px; border: 0 !important;"
                class="font-weight-bold text-center">{{ $billSale->method->name ?? null }}</td>
        </tr>
        <tr class="mt-2">
            ...
            <td colspan="8" style="font-size: 15px; border: 0 !important;"
                class="font-weight-bold text-center">{{ $billSale->description }}</td>
        </tr>
    </table>
</div>
