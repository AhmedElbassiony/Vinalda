...
<div class="list-icons">
    <div class="dropdown">
        ...
        <div class="dropdown-menu">
            <a href = "{{ route('billSale.edit' , $id) }}" class="dropdown-item" ><i class="icon-pencil7" ></i>تعديل بيانات فاتورة مبيعات </a>
            <a href = "{{ route('installment-payment.index' , $id) }}" class="dropdown-item" ><i class="icon-eye" ></i> عرض اقساط فاتورة مبيعات </a>
            <a href = "{{ route('billSale.print' , $id) }}" target="_blank" class="dropdown-item" ><i class="icon-printer" ></i> طباعة فاتورة مبيعات </a>
            <a href = "{{ route('bill.delete' , $id) }}" class="dropdown-item" onclick="return confirm('هل انت متاكد؟');"><i class="icon-trash" ></i> حذف فاتورة مبيعات </a>
