        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">اضافة ضنف رئيسى جديد</span>
                </div>
            </div>
...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">اضافة صنف رئيسى جديد</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="purchase_price" placeholder="سعر الشراء"
                                   value="{{ old('purchase_price') }}" step=any >
